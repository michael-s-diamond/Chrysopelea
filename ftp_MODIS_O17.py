...
Updated for ORACLES 2017 to only produce Nd

One stop shopping: Will create maps in this script as well.
...
Modified: Michael Diamond, 08/06/2017, Pestana, Sao Tome
    -Only Nd
    -Self-contain maps, etc in this one script
"""
